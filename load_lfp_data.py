...
recordings_folder = '/media/jorge/otherprojects/Data/Tom/lfp/'  #/Rat688/session1/all_channels/'
...
for f_idx, folder in enumerate(recording_folders):
  ...
  v_active, v_rest, v_nonrem, v_rem = load_16_lfp_downsampled(recording_folder, source_numbers[f_idx], sr, downsampling, chosen_electrodes[f_idx], d_brain_states)
